...
function addToCartClicked(event) {
	...
	var priceString = shopItemContainer.getElementsByClassName(
		"shop-item-price"
	)[0].innerText;
	var itemName = shopItemContainer.getElementsByClassName("shop-item-title")[0]
		.innerText;
	var imageUrl = shopItemContainer.getElementsByClassName("shop-item-image")[0]
		.src;
...
// this calculate and change the amount of items
...
// this is the purchase button click
...
function addItemToCart(itemName, imageUrl, priceString) {
	var cartItemContainer = document.getElementsByClassName("cart-items")[0];
	var cartItemNames = cartItemContainer.getElementsByClassName(
		"cart-item-title"
	);
